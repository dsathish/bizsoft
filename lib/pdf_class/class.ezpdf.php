...
function ezTable(&$data,$cols='',$title='',$options='',$font_size='10',$title_font_size='12'){
  ...
  $defaults = array(
    'shaded'=>0,'showLines'=>2,'shadeCol'=>array(0.8,0.8,0.8),'shadeCol2'=>array(0.7,0.7,0.7),'fontSize'=>$font_size,'titleFontSize'=>$title_font_size
